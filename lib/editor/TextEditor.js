...
const TextEditor = ({ html, setHtml, toolbar, wrapperStyle, contentEditableStyle }) => {
    ...
    return (React.createElement("div", { id: 'textEditor', style: wrapperStyle },
        React.createElement(Toolbar, { toolbarOptions: toolbarOptions, toolbarStatus: toolbarStatus, setToolbarStatus: setToolbarStatus }),
        React.createElement(ContentEditable, { style: contentEditableStyle, innerref: contentEditable, html: html, disabled: false, onChange: (e) => {
